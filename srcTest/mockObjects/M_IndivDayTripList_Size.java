...
//Searcher
public class M_IndivDayTripList_Size implements I_IndivDayTripList{
	...
	//numSeatsLeft to test Searcher.searchBySize. A few may or may not fall within the given seat minimum.
